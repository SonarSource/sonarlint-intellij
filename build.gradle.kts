...
intellijPlatform {
    ...
    sonar {
        properties {
            ...
            // Pick up coverage from both unit tests and UI ITs (the latter is generated by
            // :its:jacocoIdeReport when the IDE is run with -PitCoverage=true).
            property(
                "sonar.coverage.jacoco.xmlReportPaths",
                "build/reports/jacoco/test/jacocoTestReport.xml," +
                    "its/build/reports/jacoco/jacocoIdeReport/jacocoIdeReport.xml"
            )
        }
    }

...
dependencies {
    ...
    "sqplugins"("org.sonarsource.java:sonar-java-plugin:7.1.0.26670@jar")
    ...
    "sqplugins"("com.sonarsource.secrets:sonar-secrets-plugin:1.0.0.34586@jar")
    "sqplugins"("org.sonarsource.sonarlint.omnisharp:sonarlint-omnisharp-plugin:1.0.0.34478@jar")
    if (artifactoryUsername.isNotEmpty() && artifactoryPassword.isNotEmpty()) {

...
public class AllProjectsConsoleLoggerTest extends AbstractSonarLintLightTests {
  private AllProjectsConsoleLogger output;

  @Before
  public void prepare() {
    output = new AllProjectsConsoleLogger();
  }

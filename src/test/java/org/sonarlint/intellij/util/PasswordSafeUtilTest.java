...
public class PasswordSafeUtilTest extends AbstractSonarLintLightTests {

  @Test
  public void testPasswordSafeStoreNull() {
    PasswordSafeUtil.replaceServerAttributeInPasswordSafe("name", "value", null);
    assertThat(PasswordSafeUtil.getServerAttributeFromPasswordSafe("name", "value")).isNull();
  }

  @Test
  public void testPasswordSafeStoreValue() {
    PasswordSafeUtil.replaceServerAttributeInPasswordSafe("name", "value", "value");

...
class SearchProjectKeyDialog(
    ...
    private val projectsByKey: Map<String, SonarProject>,
    isSonarCloud: Boolean,
) : DialogWrapper(
    parent, false
) {
    private lateinit var mainPanel: JBPanel<JBPanel<*>>
    private lateinit var projectList: JBList<SonarProject>
    ...
    private fun createProjectList(): JBList<SonarProject> {
        val projectList = JBList<SonarProject>(DefaultListModel())
    ...
    private fun updateProjectsInList() {
        ...
        val selection: SonarProject? = projectList.selectedValue
    ...
    private class ProjectListRenderer : ColoredListCellRenderer<SonarProject>() {
        override fun customizeCellRenderer(
            list: JList<out SonarProject>,
            value: SonarProject,
            index: Int,
            selected: Boolean,
            hasFocus: Boolean,

...
public class DetektRuleConfigurationPanel implements Disposable, ConfigurationPanel<SonarLintGlobalSettings> {
    ...
    private static final String RIGHT_SPLITTER_KEY = "sonarlint_detekt_rule_configuration_splitter_right";
    ...
    public DetektRuleConfigurationPanel() {
        createUIComponents();
    }
    ...
    private static Map<String, String> loadNonDefaultRuleParams(SonarLintGlobalSettings settings,
    ...
    private ActionToolbar createTreeToolbarPanel() {
        ...
        ActionToolbar actionToolbar =
            ActionManager.getInstance().createActionToolbar("SonarLintRulesTreeToolbar", actions, true);
    ...
    private JPanel createUIComponents() {
        ...
        northPanel.add(myRuleFilter, new GridBagConstraints(0, 0, 1, 1, 0.5, 1, GridBagConstraints.BASELINE_TRAILING,
            GridBagConstraints.HORIZONTAL,
            JBUI.emptyInsets(), 0, 0));
        northPanel.add(createTreeToolbarPanel().getComponent(),
            new GridBagConstraints(1, 0, 1, 1, 1, 1, GridBagConstraints.BASELINE_LEADING, GridBagConstraints.HORIZONTAL,
                JBUI.emptyInsets(), 0, 0));
        ...
        northPanel.add(restoreDefaults,
            new GridBagConstraints(2, 0, 1, 1, 0, 1, GridBagConstraints.BASELINE_LEADING, GridBagConstraints.NONE,
                JBUI.emptyInsets(), 0, 0));
        ...
        JBLabel label = new JBLabel(
            "<html><b>Note: </b>When a project is bound to a SonarQube server or SonarCloud, only rules configuration from the server applies.</html>");
    ...
    private void updateParamsAndDescriptionPanel(RulesTreeNode.Rule singleNode) {
        ...
        try {
            ...
            GlobalLogOutput.get()
                .logError("Failed to load description for: " + singleNode.getKey() + "; description: " + builder, t);
        }
        ...
        if (configPanelAnchor.getComponentCount() != 0) {
            ...
            myParamsPanel.add(rulesParamsSeparator,
                new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
                    JBUI.emptyInsets(), 0, 0));
            myParamsPanel.add(configPanelAnchor,
    ...
    private void setConfigPanel(final JPanel configPanelAnchor, RulesTreeNode.Rule rule) {
        ...
        final JComponent additionalConfigPanel =
            ConfigPanelState.of(getAdditionalConfigPanel(rule), rule).getPanel(rule.activated);
    ...
    private JComponent getAdditionalConfigPanel(RulesTreeNode.Rule rule) {
        ...
        for (RulesTreeNode.RuleParam param : rule.getParamDetails()) {
            ...
            switch (param.type) {
                ...
                default:
                    GlobalLogOutput.get()
                        .log("Unknown rule parameter type: " + param.type + " for rule " + rule.getKey(),
    ...
    private void createTextParam(RulesTreeNode.Rule rule, JPanel panel, GridBagConstraints constraints,
                                 RulesTreeNode.RuleParam param) {
        addParamLabel(panel, constraints, param);
        addTextField(rule, panel, constraints, param, new JBTextArea());
    }

    private void createStringParam(RulesTreeNode.Rule rule, JPanel panel, GridBagConstraints constraints,
                                   RulesTreeNode.RuleParam param) {
        addParamLabel(panel, constraints, param);
        addTextField(rule, panel, constraints, param,
            new ExpandableTextField(s -> StringUtil.split(s, ","), l -> StringUtil.join(l, ",")));
    }

    private void createIntParam(RulesTreeNode.Rule rule, JPanel panel, GridBagConstraints constraints,
                                RulesTreeNode.RuleParam param) {
        addParamLabel(panel, constraints, param);
    ...
    private void createFloatParam(RulesTreeNode.Rule rule, JPanel panel, GridBagConstraints constraints,
                                  RulesTreeNode.RuleParam param) {
        addParamLabel(panel, constraints, param);
    ...
    private void createBooleanParam(RulesTreeNode.Rule rule, JPanel panel, GridBagConstraints constraints,
                                    RulesTreeNode.RuleParam param) {
        final JBCheckBox checkBox =
            new JBCheckBox(param.name, asBoolean(rule.getCustomParams().getOrDefault(param.key, param.defaultValue)));
    ...
    private void addTextField(RulesTreeNode.Rule rule, JPanel panel, GridBagConstraints constraints,
                              RulesTreeNode.RuleParam param, JTextComponent textComponent) {
    ...
    private void addNumberFormattedTextField(RulesTreeNode.Rule rule, JPanel panel, GridBagConstraints constraints,
                                             RulesTreeNode.RuleParam param, NumberFormat numberFormat,
    ...
    private class RulesParamsSeparator extends JPanel {
        ...
        RulesParamsSeparator() {
            ...
            GridBagConstraints optionsLabelConstraints =
                new GridBagConstraints(0, 0, 1, 1, 0, 1, GridBagConstraints.WEST, GridBagConstraints.NONE,
                    JBUI.insets(0, 2, 0, 0), 0, 0);
            ...
            GridBagConstraints defaultLabelConstraints =
                new GridBagConstraints(2, 0, 0, 1, 0, 1, GridBagConstraints.EAST, GridBagConstraints.NONE,
                    JBUI.emptyInsets(), 0, 0);

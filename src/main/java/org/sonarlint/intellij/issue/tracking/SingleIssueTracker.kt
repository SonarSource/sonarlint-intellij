...
class SingleIssueTracker<RAW : Trackable?, BASE : Trackable?> {
    ...
    private class TextRangeHashAndMessageKey internal constructor(trackable: Trackable) :
        SearchKey {
        private val ruleKey: String
    ...
    private class LineAndMessageKey internal constructor(trackable: Trackable) :
        SearchKey {
        private val ruleKey: String
        private val message: String
        private val line: Int?

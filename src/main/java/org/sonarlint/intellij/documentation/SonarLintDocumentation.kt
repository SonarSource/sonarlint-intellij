...
object SonarLintDocumentation {
    ...
    object Intellij {
        ...
        const val CONNECTED_MODE_LINK = "$BASE_DOCS_URL/connect-your-ide/connected-mode"
        const val CONNECTED_MODE_SETUP_LINK = "$BASE_DOCS_URL/connect-your-ide/setup"
        ...
        const val SUPPORT_POLICY_LINK = "$CONNECTED_MODE_SETUP_LINK/connect-your-ide/connected-mode/#sonarqube-for-ide-sonarqube-server-version-support-policy"
        ...
        const val TROUBLESHOOTING_CONNECTED_MODE_SETUP_LINK = "$BASE_DOCS_URL/resources/troubleshooting/#troubleshooting-connected-mode-setup"
        const val TROUBLESHOOTING_LINK = "$BASE_DOCS_URL/resources/troubleshooting"
    ...
    object SonarQube {
        const val SMART_NOTIFICATIONS = "https://docs.sonarsource.com/sonarqube-server/user-guide/connected-mode/#smart-notifications"
    }

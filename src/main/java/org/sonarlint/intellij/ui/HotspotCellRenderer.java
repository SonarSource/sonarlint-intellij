...
class HotspotCellRenderer implements TreeCellRenderer {
  ...
  public Component getTreeCellRendererComponent(JTree jTree, Object value, boolean selected, boolean expanded, boolean leaf, int row, boolean hasFocus) {
    ...
    JBColor validForegroundColor = selected ? whiteForeground : JBColor.BLACK;
    messageLabel.setForeground(primaryLocation.isResolved() ? validForegroundColor : JBColor.GRAY);

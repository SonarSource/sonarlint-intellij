 ...
 * @date 2016/12/11
 */
class DetektInspectionAction : AnAction() {
    ...
    companion object {
        val logger = Logger.getInstance(DetektInspectionAction::class.java)
        ...
        private fun createNewGlobalContext(
            ...
            return object : GlobalInspectionContextImpl(managerEx.project, managerEx.contentManager) {
                override fun runTools(
                    scope: AnalysisScope, runGlobalToolsOnly: Boolean,

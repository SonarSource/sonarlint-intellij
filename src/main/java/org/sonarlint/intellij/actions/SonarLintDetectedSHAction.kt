...
class SonarLintDetectedSHAction(text: String = "SonarLint Detected") : AbstractSonarAction(text, "Filter Security hotspots detected by SonarLint", SonarLintIcons.SONARLINT)  {

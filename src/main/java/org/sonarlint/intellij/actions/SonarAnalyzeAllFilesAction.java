...
public class SonarAnalyzeAllFilesAction extends AbstractSonarAction {
  ...
  private static final String ALL_FILES_ANALYSIS_TYPE = "trigger_count_all_project_files";
  ...
  public void actionPerformed(AnActionEvent e) {
    ...
    getService(SonarLintTelemetry.class).analysisReportingTriggered(ALL_FILES_ANALYSIS_TYPE);

...
import org.sonarlint.intellij.its.tests.domain.DependencyRisksTabTests.Companion.enableConnectedModeFromDependencyRisksPanel
...
class ScaTests : BaseUiTest() {
    ...
    inner class SampleMavenDependencyRiskTests : BaseUiTest() {
        ...
        fun `should show dependency risks`() {
            ...
            enableConnectedModeFromDependencyRisksPanel(SCA_PROJECT_KEY, true, "Orchestrator")

...
object SonarCloudUtils {
    ...
    fun openInIde(
        ...
        var request = GetRequest("api/issues/show")
        request = request.setParam("project", project)
        if (issue != null) {
            request = request.setParam("issue", issue)
        }
        request = request.setParam("server", server)
        request = request.setParam("branch", branch)
        request = request.setParam("tokenName", tokenName)
        request = request.setParam("tokenValue", tokenValue)
        request = request.setParam("organizationKey", organizationKey)
        request = request.setHeader("Origin", SONARCLOUD_STAGING_URL)
